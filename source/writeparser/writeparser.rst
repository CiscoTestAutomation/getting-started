...
Is the schema in JSON format? As an example, perhaps https://pubhub.devnetcloud.com/media/genie-feature-browser/docs/#/parsers IOS show interfaces, explain what 'optional' means. Ask the user to go there so they get used to finding these.
